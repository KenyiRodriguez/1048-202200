...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("CARGA LA VISTA")
        
        let service = MovieWS()
        service.getAllMovies { arrayMoviesDTO in
            print(arrayMoviesDTO.first ?? "NO HAY ELEMENTO")
        }
        
        print("INICIE EL LOGIN")
    }
...
extension LoginViewController {
    ...
    @IBAction private func clickBtnLogin(_ sender: UIButton) {
        ...
        self.performSegue(withIdentifier: "ListMoviesViewController", sender: nil)
    }
